...
public interface MyQueue<E> {
    ...
    /**
     * Places the given object in its proper place within the queue based on priority level set within aspects of queue.
     * @post The queue is in proper priority level.
     * @return The object's distance from the front of the queue.
     */
    boolean prioritize(E obj);
 }